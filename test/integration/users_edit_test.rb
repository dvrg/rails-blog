...
class UsersEditTest < ActionDispatch::IntegrationTest
  ...
  test "successful edit with friendly forwading" do
    get edit_user_path(@user) # get halaman edit user
    log_in_as(@user) # login dengan kredensial
    assert_redirected_to edit_user_url(@user) # redirect ke halaman edit usernya
    name = "Foo Bar"
    email = "foo@bar.com"
